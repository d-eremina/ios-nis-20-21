...
//  02InTouch
//
//  Created by Daria Eremina on 28.10.2020.
//
...
class ViewController: UIViewController, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func sendEmail(_ sender: AnyObject) {
        ...
        {
            let mailVC = MFMailComposeViewController(); mailVC.setSubject("MySubject"); mailVC.setToRecipients(["dveremina@edu.hse.ru"]); mailVC.setMessageBody("<p>Hello!</p>", isHTML: true); mailVC.mailComposeDelegate = self;
